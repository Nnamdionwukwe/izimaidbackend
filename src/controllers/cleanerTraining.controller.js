// src/controllers/cleanerTraining.controller.js
...
export const createApplication = async (req, res) => {
  ...
  try {
    ...
    const existingApplications = await CleanerApplication.findByEmail(email);
    ...
    console.log(
      `[cleaner-training] New application from ${email} (${application.reference_number})`,
    );
    ...
    console.error("[cleanerTraining.controller/createApplication]", error);
...
export const listApplications = async (req, res) => {
  ...
  try {
    const result = await CleanerApplication.findAll({
      status,
      city,
      track,
      page: parseInt(page),
    ...
    console.error("[cleanerTraining.controller/listApplications]", error);
    return res.status(500).json({
      success: false,
...
export const getApplication = async (req, res) => {
  ...
  try {
    const application = await CleanerApplication.findById(id);
    ...
    console.error("[cleanerTraining.controller/getApplication]", error);
    return res.status(500).json({
      success: false,
      error: "Internal server error",
    });
...
export const updateApplicationStatus = async (req, res) => {
  ...
  try {
    const application = await CleanerApplication.updateStatus(
      id,
      status,
      notes,
      req.user?.id,
    ...
    console.error(
      "[cleanerTraining.controller/updateApplicationStatus]",
      error,
    );
    return res.status(500).json({
      success: false,
...
export const updateAdminNotes = async (req, res) => {
  ...
  try {
    const application = await CleanerApplication.updateAdminNotes(id, notes);
    ...
    console.error("[cleanerTraining.controller/updateAdminNotes]", error);
    return res.status(500).json({
      success: false,
      error: "Internal server error",
    });
...
export const deleteApplication = async (req, res) => {
  ...
  try {
    const application = await CleanerApplication.delete(id);
    ...
    console.error("[cleanerTraining.controller/deleteApplication]", error);
    return res.status(500).json({
      success: false,
      error: "Internal server error",
    });
...
export const getApplicationStats = async (req, res) => {
  try {
    const stats = await CleanerApplication.getStats();
    ...
    console.error("[cleanerTraining.controller/getApplicationStats]", error);
    return res.status(500).json({
      success: false,
      error: "Internal server error",
    });
...
export const bulkUpdateStatus = async (req, res) => {
  ...
  try {
    ...
    console.error("[cleanerTraining.controller/bulkUpdateStatus]", error);
    return res.status(500).json({
      success: false,
      error: "Internal server error",
    });
